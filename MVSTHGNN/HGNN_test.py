...
from HGNN import generate_G_from_H, hyperedge_concat, construct_H_with_KNN
...
# valid_root = '/home/mn/8T/code/new-hgnn/MVSTHGNN/data/train/json/'
...
class MyDataSet(Dataset):
    def __init__(self, flag='train'):
        ...
        # gen G: n * n
        H_g = construct_H_with_KNN(cur_x.cpu().detach().numpy(), K_neigs=[10],
                                                    is_probH=True, m_prob=1.0, mode="global", total_node_num=18, S=8)
        H = hyperedge_concat(H, H_g)
...
def train_it():
    ...
    sys.stdout = Logger(osp.join('/home/mn/8T/code/new-hgnn/MVSTHGNN/log/police_log/',
                                 'log_HGNN_{}.txt'.format(time.strftime('-%Y-%m-%d-%H-%M-%S'))))
