...
from json2data_NTU import json2data
...
train_root = '/home/mn/8T/code/new-hgnn/MVSTHGNN/data/NTU-RGB+D/'
valid_root = '/home/mn/8T/code/new-hgnn/MVSTHGNN/data/NTU-RGB+D/'
...
class FrameWiseHGNN(nn.Module):
    def __init__(self, hids=[3, 32, 64, 128], class_num=60):
